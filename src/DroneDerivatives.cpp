...
Eigen::SparseMatrix<double> DroneTrajectory::dhdxPlus(SystemState state, double time, double timestep)
{
    ...
    dhdx.push_back(T(eixdot, x, -timestep*cos(state.plant(psi))));
    dhdx.push_back(T(eixdot, y, -timestep*sin(state.plant(psi))));
    ...
    dhdx.push_back(T(eiydot, x, timestep*sin(state.plant(psi))));
    dhdx.push_back(T(eiydot, y, -timestep*cos(state.plant(psi))));
...
//     dhdx.push_back(T(eix, 0, -timestep*cos(state.plant(psi))));
//     dhdx.push_back(T(eix, 1, -timestep*sin(state.plant(psi))));
//     dhdx.push_back(T(eix, 5, timestep*(cos(state.plant(psi))*(m_ref.at(refy)(time) - state.plant(y)) - sin(state.plant(psi))*(m_ref.at(refx)(time) - state.plant(x)))));
//     dhdx.push_back(T(edx, 0, -cos(state.plant(psi))/timestep));
//     dhdx.push_back(T(edx, 1, -sin(state.plant(psi))/timestep));
//     dhdx.push_back(T(edx, 5, -(state.plant(y)*cos(state.plant(psi)) - state.plant(x)*sin(state.plant(psi)))/timestep));
//     dhdx.push_back(T(desVelX, 0, -(cos(state.plant(psi))*(m_ctrlParams.at(posX).kd + m_ctrlParams.at(posX).kp*timestep + m_ctrlParams.at(posX).ki*std::pow(timestep, 2)))/timestep));
//     dhdx.push_back(T(desVelX, 1, -(sin(state.plant(psi))*(m_ctrlParams.at(posX).kd + m_ctrlParams.at(posX).kp*timestep + m_ctrlParams.at(posX).ki*std::pow(timestep, 2)))/timestep));
//     dhdx.push_back(T(desVelX, 5, m_ctrlParams.at(posX).kp*(cos(state.plant(psi))*(m_ref.at(refy)(time) - state.plant(y)) - sin(state.plant(psi))*(m_ref.at(refx)(time) - state.plant(x))) - (m_ctrlParams.at(posX).kd*(state.plant(y)*cos(state.plant(psi)) - state.plant(x)*sin(state.plant(psi))))/timestep + m_ctrlParams.at(posX).ki*timestep*(cos(state.plant(psi))*(m_ref.at(refy)(time) - state.plant(y)) - sin(state.plant(psi))*(m_ref.at(refx)(time) - state.plant(x)))));
//     dhdx.push_back(T(eiy, 0, timestep*sin(state.plant(psi))));
//     dhdx.push_back(T(eiy, 1, -timestep*cos(state.plant(psi))));
//     dhdx.push_back(T(eiy, 5, -timestep*(cos(state.plant(psi))*(m_ref.at(refx)(time) - state.plant(x)) + sin(state.plant(psi))*(m_ref.at(refy)(time) - state.plant(y)))));
//     dhdx.push_back(T(edy, 0, sin(state.plant(psi))/timestep));
//     dhdx.push_back(T(edy, 1, -cos(state.plant(psi))/timestep));
//     dhdx.push_back(T(edy, 5, (state.plant(x)*cos(state.plant(psi)) + state.plant(y)*sin(state.plant(psi)))/timestep));
//     dhdx.push_back(T(desVelY, 0, (sin(state.plant(psi))*(m_ctrlParams.at(posY).kd + m_ctrlParams.at(posY).kp*timestep + m_ctrlParams.at(posY).ki*std::pow(timestep, 2)))/timestep));
//     dhdx.push_back(T(desVelY, 1, -(cos(state.plant(psi))*(m_ctrlParams.at(posY).kd + m_ctrlParams.at(posY).kp*timestep + m_ctrlParams.at(posY).ki*std::pow(timestep, 2)))/timestep));
//     dhdx.push_back(T(desVelY, 5, (m_ctrlParams.at(posY).kd*(state.plant(x)*cos(state.plant(psi)) + state.plant(y)*sin(state.plant(psi))))/timestep - m_ctrlParams.at(posY).kp*(cos(state.plant(psi))*(m_ref.at(refx)(time) - state.plant(x)) + sin(state.plant(psi))*(m_ref.at(refy)(time) - state.plant(y))) - m_ctrlParams.at(posY).ki*timestep*(cos(state.plant(psi))*(m_ref.at(refx)(time) - state.plant(x)) + sin(state.plant(psi))*(m_ref.at(refy)(time) - state.plant(y)))));
...
//     dhdx.push_back(T(eixdot, 0, -cos(state.plant(psi))*(m_ctrlParams.at(posX).kd + m_ctrlParams.at(posX).kp*timestep + m_ctrlParams.at(posX).ki*std::pow(timestep, 2))));
//     dhdx.push_back(T(eixdot, 1, -sin(state.plant(psi))*(m_ctrlParams.at(posX).kd + m_ctrlParams.at(posX).kp*timestep + m_ctrlParams.at(posX).ki*std::pow(timestep, 2))));
//     dhdx.push_back(T(eixdot, 5, timestep*(state.plant(xdot)*sin(state.plant(psi)) - state.plant(ydot)*cos(state.plant(psi)) + m_ctrlParams.at(posX).kp*(cos(state.plant(psi))*(m_ref.at(refy)(time) - state.plant(y)) - sin(state.plant(psi))*(m_ref.at(refx)(time) - state.plant(x))) - (m_ctrlParams.at(posX).kd*(state.plant(y)*cos(state.plant(psi)) - state.plant(x)*sin(state.plant(psi))))/timestep + m_ctrlParams.at(posX).ki*timestep*(cos(state.plant(psi))*(m_ref.at(refy)(time) - state.plant(y)) - sin(state.plant(psi))*(m_ref.at(refx)(time) - state.plant(x))))));
//     dhdx.push_back(T(eixdot, 6, -timestep*cos(state.plant(psi))));
//     dhdx.push_back(T(eixdot, 7, -timestep*sin(state.plant(psi))));
//     dhdx.push_back(T(edxdot, 5, -(state.plant(ydot)*cos(state.plant(psi)) - state.plant(xdot)*sin(state.plant(psi)))/timestep));
//     dhdx.push_back(T(edxdot, 6, -cos(state.plant(psi))/timestep));
//     dhdx.push_back(T(edxdot, 7, -sin(state.plant(psi))/timestep));
//     dhdx.push_back(T(eiydot, 0, sin(state.plant(psi))*(m_ctrlParams.at(posY).kd + m_ctrlParams.at(posY).kp*timestep + m_ctrlParams.at(posY).ki*std::pow(timestep, 2))));
//     dhdx.push_back(T(eiydot, 1, -cos(state.plant(psi))*(m_ctrlParams.at(posY).kd + m_ctrlParams.at(posY).kp*timestep + m_ctrlParams.at(posY).ki*std::pow(timestep, 2))));
//     dhdx.push_back(T(eiydot, 5, timestep*(state.plant(xdot)*cos(state.plant(psi)) + state.plant(ydot)*sin(state.plant(psi)) - m_ctrlParams.at(posY).kp*(cos(state.plant(psi))*(m_ref.at(refx)(time) - state.plant(x)) + sin(state.plant(psi))*(m_ref.at(refy)(time) - state.plant(y))) + (m_ctrlParams.at(posY).kd*(state.plant(x)*cos(state.plant(psi)) + state.plant(y)*sin(state.plant(psi))))/timestep - m_ctrlParams.at(posY).ki*timestep*(cos(state.plant(psi))*(m_ref.at(refx)(time) - state.plant(x)) + sin(state.plant(psi))*(m_ref.at(refy)(time) - state.plant(y))))));
//     dhdx.push_back(T(eiydot, 6, timestep*sin(state.plant(psi))));
//     dhdx.push_back(T(eiydot, 7, -timestep*cos(state.plant(psi))));
//     dhdx.push_back(T(edydot, 5, (state.plant(xdot)*cos(state.plant(psi)) + state.plant(ydot)*sin(state.plant(psi)))/timestep));
//     dhdx.push_back(T(edydot, 6, sin(state.plant(psi))/timestep));
//     dhdx.push_back(T(edydot, 7, -cos(state.plant(psi))/timestep));
//     dhdx.push_back(T(eizdot, 2, - m_ctrlParams.at(posZ).kd - m_ctrlParams.at(posZ).kp*timestep - m_ctrlParams.at(posZ).ki*std::pow(timestep, 2)));
//     dhdx.push_back(T(eizdot, 8, -timestep));
//     dhdx.push_back(T(edzdot, 8, -1/timestep));
//     dhdx.push_back(T(desThrust, 2, -(m_thrustScale*(m_ctrlParams.at(velZ).kp + m_ctrlParams.at(velZ).ki*timestep)*(m_ctrlParams.at(posZ).kd + m_ctrlParams.at(posZ).kp*timestep + m_ctrlParams.at(posZ).ki*std::pow(timestep, 2)))/timestep));
...
//     dhdx.push_back(T(desRollRate, 3, -(180*(m_ctrlParams.at(roll).kd + m_ctrlParams.at(roll).kp*timestep + m_ctrlParams.at(roll).ki*std::pow(timestep, 2)))/(M_PI*timestep)));
//     dhdx.push_back(T(eitheta, 4, -(180*timestep)/M_PI));
//     dhdx.push_back(T(edtheta, 4, -180/(M_PI*timestep)));
//     dhdx.push_back(T(desPitchRate, 4, -(180*(m_ctrlParams.at(pitch).kd + m_ctrlParams.at(pitch).kp*timestep + m_ctrlParams.at(pitch).ki*std::pow(timestep, 2)))/(M_PI*timestep)));
//     dhdx.push_back(T(eipsi, 5, -(180*timestep)/M_PI));
//     dhdx.push_back(T(edpsi, 5, -180/(M_PI*timestep)));
//     dhdx.push_back(T(desYawRate, 5, -(180*(m_ctrlParams.at(yaw).kd + m_ctrlParams.at(yaw).kp*timestep + m_ctrlParams.at(yaw).ki*std::pow(timestep, 2)))/(M_PI*timestep)));
//     dhdx.push_back(T(eip, 3, -(180*m_ctrlParams.at(roll).kd + 180*m_ctrlParams.at(roll).kp*timestep + 180*m_ctrlParams.at(roll).ki*std::pow(timestep, 2))/M_PI));
//     dhdx.push_back(T(eip, 9, -(180*timestep)/M_PI));
//     dhdx.push_back(T(edp, 9, -(180*lpf_b0)/(M_PI*timestep)));
//     dhdx.push_back(T(desRollOutput, 3, -(180*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep)*(m_ctrlParams.at(roll).kd + m_ctrlParams.at(roll).kp*timestep + m_ctrlParams.at(roll).ki*std::pow(timestep, 2)))/(M_PI*timestep)));
//     dhdx.push_back(T(desRollOutput, 9, -(180*(lpf_b0*m_ctrlParams.at(rollRate).kd + m_ctrlParams.at(rollRate).kp*timestep + m_ctrlParams.at(rollRate).ki*std::pow(timestep, 2)))/(M_PI*timestep)));
//     dhdx.push_back(T(eiq, 4, -(180*m_ctrlParams.at(pitch).kd + 180*m_ctrlParams.at(pitch).kp*timestep + 180*m_ctrlParams.at(pitch).ki*std::pow(timestep, 2))/M_PI));
//     dhdx.push_back(T(eiq, 10, -(180*timestep)/M_PI));
//     dhdx.push_back(T(edq, 10, -(180*lpf_b0)/(M_PI*timestep)));
//     dhdx.push_back(T(desPitchOutput, 4, -(180*(m_ctrlParams.at(pitchRate).kp + m_ctrlParams.at(pitchRate).ki*timestep)*(m_ctrlParams.at(pitch).kd + m_ctrlParams.at(pitch).kp*timestep + m_ctrlParams.at(pitch).ki*std::pow(timestep, 2)))/(M_PI*timestep)));
//     dhdx.push_back(T(desPitchOutput, 10, -(180*(lpf_b0*m_ctrlParams.at(pitchRate).kd + m_ctrlParams.at(pitchRate).kp*timestep + m_ctrlParams.at(pitchRate).ki*std::pow(timestep, 2)))/(M_PI*timestep)));
//     dhdx.push_back(T(eir, 5, -(180*m_ctrlParams.at(yaw).kd + 180*m_ctrlParams.at(yaw).kp*timestep + 180*m_ctrlParams.at(yaw).ki*std::pow(timestep, 2))/M_PI));
//     dhdx.push_back(T(eir, 11, -(180*timestep)/M_PI));
//     dhdx.push_back(T(edr, 11, -180/(M_PI*timestep)));
//     dhdx.push_back(T(desYawOutput, 5, -(180*(m_ctrlParams.at(yawRate).kp + m_ctrlParams.at(yawRate).ki*timestep)*(m_ctrlParams.at(yaw).kd + m_ctrlParams.at(yaw).kp*timestep + m_ctrlParams.at(yaw).ki*std::pow(timestep, 2)))/(M_PI*timestep)));
//     dhdx.push_back(T(desYawOutput, 11, -(180*(m_ctrlParams.at(yawRate).kd + m_ctrlParams.at(yawRate).kp*timestep + m_ctrlParams.at(yawRate).ki*std::pow(timestep, 2)))/(M_PI*timestep)));
...
//         dhdx.push_back(T(eiphi, 5, -timestep*(m_ctrlParams.at(velY).kp*(state.plant(xdot)*cos(state.plant(psi)) + state.plant(ydot)*sin(state.plant(psi)) - m_ctrlParams.at(posY).kp*(cos(state.plant(psi))*(m_ref.at(refx)(time) - state.plant(x)) + sin(state.plant(psi))*(m_ref.at(refy)(time) - state.plant(y))) + (m_ctrlParams.at(posY).kd*(state.plant(x)*cos(state.plant(psi)) + state.plant(y)*sin(state.plant(psi))))/timestep - m_ctrlParams.at(posY).ki*timestep*(cos(state.plant(psi))*(m_ref.at(refx)(time) - state.plant(x)) + sin(state.plant(psi))*(m_ref.at(refy)(time) - state.plant(y)))) + (m_ctrlParams.at(velY).kd*(state.plant(xdot)*cos(state.plant(psi)) + state.plant(ydot)*sin(state.plant(psi))))/timestep + m_ctrlParams.at(velY).ki*timestep*(state.plant(xdot)*cos(state.plant(psi)) + state.plant(ydot)*sin(state.plant(psi)) - m_ctrlParams.at(posY).kp*(cos(state.plant(psi))*(m_ref.at(refx)(time) - state.plant(x)) + sin(state.plant(psi))*(m_ref.at(refy)(time) - state.plant(y))) + (m_ctrlParams.at(posY).kd*(state.plant(x)*cos(state.plant(psi)) + state.plant(y)*sin(state.plant(psi))))/timestep - m_ctrlParams.at(posY).ki*timestep*(cos(state.plant(psi))*(m_ref.at(refx)(time) - state.plant(x)) + sin(state.plant(psi))*(m_ref.at(refy)(time) - state.plant(y)))))));
...
//         dhdx.push_back(T(desRollRate, 5, -((m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(velY).kd*state.plant(xdot)*cos(state.plant(psi)) + m_ctrlParams.at(velY).kd*state.plant(ydot)*sin(state.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*state.plant(x)*cos(state.plant(psi)) + m_ctrlParams.at(velY).kp*timestep*state.plant(xdot)*cos(state.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*state.plant(y)*sin(state.plant(psi)) + m_ctrlParams.at(velY).kp*timestep*state.plant(ydot)*sin(state.plant(psi)) + m_ctrlParams.at(velY).ki*std::pow(timestep, 2)*state.plant(xdot)*cos(state.plant(psi)) + m_ctrlParams.at(velY).ki*std::pow(timestep, 2)*state.plant(ydot)*sin(state.plant(psi)) - m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).kp*m_ref.at(refy)(time)*timestep*sin(state.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*timestep*state.plant(y)*sin(state.plant(psi)) + m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).kp*timestep*state.plant(y)*sin(state.plant(psi)) - m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).ki*m_ref.at(refx)(time)*std::pow(timestep, 3)*cos(state.plant(psi)) - m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kp*m_ref.at(refx)(time)*std::pow(timestep, 2)*cos(state.plant(psi)) - m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).ki*m_ref.at(refx)(time)*std::pow(timestep, 2)*cos(state.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).ki*std::pow(timestep, 3)*state.plant(x)*cos(state.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kp*std::pow(timestep, 2)*state.plant(x)*cos(state.plant(psi)) + m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).ki*std::pow(timestep, 2)*state.plant(x)*cos(state.plant(psi)) - m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).ki*m_ref.at(refy)(time)*std::pow(timestep, 3)*sin(state.plant(psi)) - m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kp*m_ref.at(refy)(time)*std::pow(timestep, 2)*sin(state.plant(psi)) - m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).ki*m_ref.at(refy)(time)*std::pow(timestep, 2)*sin(state.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).ki*std::pow(timestep, 3)*state.plant(y)*sin(state.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kp*std::pow(timestep, 2)*state.plant(y)*sin(state.plant(psi)) + m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).ki*std::pow(timestep, 2)*state.plant(y)*sin(state.plant(psi)) - m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).kp*m_ref.at(refx)(time)*timestep*cos(state.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*timestep*state.plant(x)*cos(state.plant(psi)) + m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).kp*timestep*state.plant(x)*cos(state.plant(psi))))/timestep));
...
//         dhdx.push_back(T(eip, 5, -(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(velY).kd*state.plant(xdot)*cos(state.plant(psi)) + m_ctrlParams.at(velY).kd*state.plant(ydot)*sin(state.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*state.plant(x)*cos(state.plant(psi)) + m_ctrlParams.at(velY).kp*timestep*state.plant(xdot)*cos(state.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*state.plant(y)*sin(state.plant(psi)) + m_ctrlParams.at(velY).kp*timestep*state.plant(ydot)*sin(state.plant(psi)) + m_ctrlParams.at(velY).ki*std::pow(timestep, 2)*state.plant(xdot)*cos(state.plant(psi)) + m_ctrlParams.at(velY).ki*std::pow(timestep, 2)*state.plant(ydot)*sin(state.plant(psi)) - m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).kp*m_ref.at(refy)(time)*timestep*sin(state.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*timestep*state.plant(y)*sin(state.plant(psi)) + m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).kp*timestep*state.plant(y)*sin(state.plant(psi)) - m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).ki*m_ref.at(refx)(time)*std::pow(timestep, 3)*cos(state.plant(psi)) - m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kp*m_ref.at(refx)(time)*std::pow(timestep, 2)*cos(state.plant(psi)) - m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).ki*m_ref.at(refx)(time)*std::pow(timestep, 2)*cos(state.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).ki*std::pow(timestep, 3)*state.plant(x)*cos(state.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kp*std::pow(timestep, 2)*state.plant(x)*cos(state.plant(psi)) + m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).ki*std::pow(timestep, 2)*state.plant(x)*cos(state.plant(psi)) - m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).ki*m_ref.at(refy)(time)*std::pow(timestep, 3)*sin(state.plant(psi)) - m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kp*m_ref.at(refy)(time)*std::pow(timestep, 2)*sin(state.plant(psi)) - m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).ki*m_ref.at(refy)(time)*std::pow(timestep, 2)*sin(state.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).ki*std::pow(timestep, 3)*state.plant(y)*sin(state.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kp*std::pow(timestep, 2)*state.plant(y)*sin(state.plant(psi)) + m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).ki*std::pow(timestep, 2)*state.plant(y)*sin(state.plant(psi)) - m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).kp*m_ref.at(refx)(time)*timestep*cos(state.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*timestep*state.plant(x)*cos(state.plant(psi)) + m_ctrlParams.at(velY).kp*m_ctrlParams.at(posY).kp*timestep*state.plant(x)*cos(state.plant(psi)))));
...
//         dhdx.push_back(T(w1, 6, (m_alpha*sin(state.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep)*(m_ctrlParams.at(velY).kd + m_ctrlParams.at(velY).kp*timestep + m_ctrlParams.at(velY).ki*std::pow(timestep, 2)))/(2*timestep)));
//         dhdx.push_back(T(w1, 7, -(m_alpha*cos(state.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep)*(m_ctrlParams.at(velY).kd + m_ctrlParams.at(velY).kp*timestep + m_ctrlParams.at(velY).ki*std::pow(timestep, 2)))/(2*timestep)));
//         dhdx.push_back(T(w2, 6, (m_alpha*sin(state.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep)*(m_ctrlParams.at(velY).kd + m_ctrlParams.at(velY).kp*timestep + m_ctrlParams.at(velY).ki*std::pow(timestep, 2)))/(2*timestep)));
//         dhdx.push_back(T(w2, 7, -(m_alpha*cos(state.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep)*(m_ctrlParams.at(velY).kd + m_ctrlParams.at(velY).kp*timestep + m_ctrlParams.at(velY).ki*std::pow(timestep, 2)))/(2*timestep)));
//         dhdx.push_back(T(w3, 6, -(m_alpha*sin(state.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep)*(m_ctrlParams.at(velY).kd + m_ctrlParams.at(velY).kp*timestep + m_ctrlParams.at(velY).ki*std::pow(timestep, 2)))/(2*timestep)));
//         dhdx.push_back(T(w3, 7, (m_alpha*cos(state.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep)*(m_ctrlParams.at(velY).kd + m_ctrlParams.at(velY).kp*timestep + m_ctrlParams.at(velY).ki*std::pow(timestep, 2)))/(2*timestep)));
//         dhdx.push_back(T(w4, 6, -(m_alpha*sin(state.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep)*(m_ctrlParams.at(velY).kd + m_ctrlParams.at(velY).kp*timestep + m_ctrlParams.at(velY).ki*std::pow(timestep, 2)))/(2*timestep)));
//         dhdx.push_back(T(w4, 7, (m_alpha*cos(state.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep)*(m_ctrlParams.at(velY).kd + m_ctrlParams.at(velY).kp*timestep + m_ctrlParams.at(velY).ki*std::pow(timestep, 2)))/(2*timestep)));
//     }
//     if (state.alge(desPitch) > -20  && state.alge(desPitch) < 20)
//     {
...
//         dhdx.push_back(T(w1, 6, -(m_alpha*cos(state.plant(psi))*(m_ctrlParams.at(pitch).kp + m_ctrlParams.at(pitch).ki*timestep)*(m_ctrlParams.at(pitchRate).kp + m_ctrlParams.at(pitchRate).ki*timestep)*(m_ctrlParams.at(velX).kd + m_ctrlParams.at(velX).kp*timestep + m_ctrlParams.at(velX).ki*std::pow(timestep, 2)))/(2*timestep)));
//         dhdx.push_back(T(w1, 7, -(m_alpha*sin(state.plant(psi))*(m_ctrlParams.at(pitch).kp + m_ctrlParams.at(pitch).ki*timestep)*(m_ctrlParams.at(pitchRate).kp + m_ctrlParams.at(pitchRate).ki*timestep)*(m_ctrlParams.at(velX).kd + m_ctrlParams.at(velX).kp*timestep + m_ctrlParams.at(velX).ki*std::pow(timestep, 2)))/(2*timestep)));
//         dhdx.push_back(T(w2, 6, (m_alpha*cos(state.plant(psi))*(m_ctrlParams.at(pitch).kp + m_ctrlParams.at(pitch).ki*timestep)*(m_ctrlParams.at(pitchRate).kp + m_ctrlParams.at(pitchRate).ki*timestep)*(m_ctrlParams.at(velX).kd + m_ctrlParams.at(velX).kp*timestep + m_ctrlParams.at(velX).ki*std::pow(timestep, 2)))/(2*timestep)));
//         dhdx.push_back(T(w2, 7, (m_alpha*sin(state.plant(psi))*(m_ctrlParams.at(pitch).kp + m_ctrlParams.at(pitch).ki*timestep)*(m_ctrlParams.at(pitchRate).kp + m_ctrlParams.at(pitchRate).ki*timestep)*(m_ctrlParams.at(velX).kd + m_ctrlParams.at(velX).kp*timestep + m_ctrlParams.at(velX).ki*std::pow(timestep, 2)))/(2*timestep)));
//         dhdx.push_back(T(w3, 6, (m_alpha*cos(state.plant(psi))*(m_ctrlParams.at(pitch).kp + m_ctrlParams.at(pitch).ki*timestep)*(m_ctrlParams.at(pitchRate).kp + m_ctrlParams.at(pitchRate).ki*timestep)*(m_ctrlParams.at(velX).kd + m_ctrlParams.at(velX).kp*timestep + m_ctrlParams.at(velX).ki*std::pow(timestep, 2)))/(2*timestep)));
//         dhdx.push_back(T(w3, 7, (m_alpha*sin(state.plant(psi))*(m_ctrlParams.at(pitch).kp + m_ctrlParams.at(pitch).ki*timestep)*(m_ctrlParams.at(pitchRate).kp + m_ctrlParams.at(pitchRate).ki*timestep)*(m_ctrlParams.at(velX).kd + m_ctrlParams.at(velX).kp*timestep + m_ctrlParams.at(velX).ki*std::pow(timestep, 2)))/(2*timestep)));
//         dhdx.push_back(T(w4, 6, -(m_alpha*cos(state.plant(psi))*(m_ctrlParams.at(pitch).kp + m_ctrlParams.at(pitch).ki*timestep)*(m_ctrlParams.at(pitchRate).kp + m_ctrlParams.at(pitchRate).ki*timestep)*(m_ctrlParams.at(velX).kd + m_ctrlParams.at(velX).kp*timestep + m_ctrlParams.at(velX).ki*std::pow(timestep, 2)))/(2*timestep)));
//         dhdx.push_back(T(w4, 7, -(m_alpha*sin(state.plant(psi))*(m_ctrlParams.at(pitch).kp + m_ctrlParams.at(pitch).ki*timestep)*(m_ctrlParams.at(pitchRate).kp + m_ctrlParams.at(pitchRate).ki*timestep)*(m_ctrlParams.at(velX).kd + m_ctrlParams.at(velX).kp*timestep + m_ctrlParams.at(velX).ki*std::pow(timestep, 2)))/(2*timestep)));
