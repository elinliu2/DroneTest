...
Eigen::SparseMatrix<double> DroneTrajectory::dhdxCurr(SystemState curr, SystemState prev, double timestep)
{
    ...
    if (curr.alge(desRoll) > -20 && curr.alge(desRoll) < 20)
    {
        ...
        dhdx.push_back(T(w1, 5, m_alpha*((m_ctrlParams.at(rollRate).ki*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(velY).kd*prev.plant(xdot)*cos(prev.plant(psi)) + m_ctrlParams.at(velY).kd*prev.plant(ydot)*sin(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(x)*cos(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(y)*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(y)*timestep*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(x)*timestep*cos(prev.plant(psi))))/2 + (180*m_ctrlParams.at(yaw).kd*m_ctrlParams.at(yawRate).ki)/M_PI + (m_ctrlParams.at(rollRate).kp*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(velY).kd*prev.plant(xdot)*cos(prev.plant(psi)) + m_ctrlParams.at(velY).kd*prev.plant(ydot)*sin(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(x)*cos(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(y)*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(y)*timestep*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(x)*timestep*cos(prev.plant(psi))))/(2*timestep) + (180*m_ctrlParams.at(yaw).kd*m_ctrlParams.at(yawRate).kp)/(M_PI*timestep))));
        dhdx.push_back(T(w1, 6, (m_ctrlParams.at(velY).kd*m_alpha*sin(prev.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep))/(2*timestep)));
        dhdx.push_back(T(w1, 7, -(m_ctrlParams.at(velY).kd*m_alpha*cos(prev.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep))/(2*timestep)));
        ...
        dhdx.push_back(T(w2, 5, m_alpha*((m_ctrlParams.at(rollRate).ki*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(velY).kd*prev.plant(xdot)*cos(prev.plant(psi)) + m_ctrlParams.at(velY).kd*prev.plant(ydot)*sin(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(x)*cos(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(y)*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(y)*timestep*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(x)*timestep*cos(prev.plant(psi))))/2 - (180*m_ctrlParams.at(yaw).kd*m_ctrlParams.at(yawRate).ki)/M_PI + (m_ctrlParams.at(rollRate).kp*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(velY).kd*prev.plant(xdot)*cos(prev.plant(psi)) + m_ctrlParams.at(velY).kd*prev.plant(ydot)*sin(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(x)*cos(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(y)*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(y)*timestep*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(x)*timestep*cos(prev.plant(psi))))/(2*timestep) - (180*m_ctrlParams.at(yaw).kd*m_ctrlParams.at(yawRate).kp)/(M_PI*timestep))));
        dhdx.push_back(T(w2, 6, (m_ctrlParams.at(velY).kd*m_alpha*sin(prev.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep))/(2*timestep)));
        dhdx.push_back(T(w2, 7, -(m_ctrlParams.at(velY).kd*m_alpha*cos(prev.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep))/(2*timestep)));
        ...
        dhdx.push_back(T(w3, 5, -m_alpha*((m_ctrlParams.at(rollRate).ki*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(velY).kd*prev.plant(xdot)*cos(prev.plant(psi)) + m_ctrlParams.at(velY).kd*prev.plant(ydot)*sin(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(x)*cos(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(y)*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(y)*timestep*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(x)*timestep*cos(prev.plant(psi))))/2 - (180*m_ctrlParams.at(yaw).kd*m_ctrlParams.at(yawRate).ki)/M_PI + (m_ctrlParams.at(rollRate).kp*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(velY).kd*prev.plant(xdot)*cos(prev.plant(psi)) + m_ctrlParams.at(velY).kd*prev.plant(ydot)*sin(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(x)*cos(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(y)*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(y)*timestep*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(x)*timestep*cos(prev.plant(psi))))/(2*timestep) - (180*m_ctrlParams.at(yaw).kd*m_ctrlParams.at(yawRate).kp)/(M_PI*timestep))));
        dhdx.push_back(T(w3, 6, -(m_ctrlParams.at(velY).kd*m_alpha*sin(prev.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep))/(2*timestep)));
        dhdx.push_back(T(w3, 7, (m_ctrlParams.at(velY).kd*m_alpha*cos(prev.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep))/(2*timestep)));
        ...
        dhdx.push_back(T(w4, 5, -m_alpha*((m_ctrlParams.at(rollRate).ki*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(velY).kd*prev.plant(xdot)*cos(prev.plant(psi)) + m_ctrlParams.at(velY).kd*prev.plant(ydot)*sin(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(x)*cos(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(y)*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(y)*timestep*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(x)*timestep*cos(prev.plant(psi))))/2 + (180*m_ctrlParams.at(yaw).kd*m_ctrlParams.at(yawRate).ki)/M_PI + (m_ctrlParams.at(rollRate).kp*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(velY).kd*prev.plant(xdot)*cos(prev.plant(psi)) + m_ctrlParams.at(velY).kd*prev.plant(ydot)*sin(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(x)*cos(prev.plant(psi)) + m_ctrlParams.at(posY).kd*m_ctrlParams.at(velY).kp*prev.plant(y)*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(y)*timestep*sin(prev.plant(psi)) + m_ctrlParams.at(velY).ki*m_ctrlParams.at(posY).kd*prev.plant(x)*timestep*cos(prev.plant(psi))))/(2*timestep) + (180*m_ctrlParams.at(yaw).kd*m_ctrlParams.at(yawRate).kp)/(M_PI*timestep))));
        dhdx.push_back(T(w4, 6, -(m_ctrlParams.at(velY).kd*m_alpha*sin(prev.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep))/(2*timestep)));
        dhdx.push_back(T(w4, 7, (m_ctrlParams.at(velY).kd*m_alpha*cos(prev.plant(psi))*(m_ctrlParams.at(roll).kp + m_ctrlParams.at(roll).ki*timestep)*(m_ctrlParams.at(rollRate).kp + m_ctrlParams.at(rollRate).ki*timestep))/(2*timestep)));
    } 
